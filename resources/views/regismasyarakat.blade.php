          ...
          <div class="container-fluid ps-2 pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link me-2" href="/administrator">
                      <i class="fa fa-user opacity-6 text-dark me-1"></i>
                      Sebagai Administrator
                    </a>
                  </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="/masyarakat">
                    <i class="fa fa-user opacity-6 text-dark me-1"></i>
                    Sebagai Masyarakat
                  </a>
                </li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('{{ asset('halo/assets/img/illustrations/danger-chat-ill.png')}}'); background-size: cover;">
              </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Daftar Masyarakat</h4>
                  <p class="mb-0">Masukan email dan password untuk daftar</p>
                </div>
                <div class="card-body">
                    <form action="/simpanmasyarakat" method="post" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    Sudah punya akun?
                    <a href="/" class="text-primary text-gradient font-weight-bold">Masuk</a>
                  </p>
                </div>
              </div>
            </div>
