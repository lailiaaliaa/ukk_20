                  ...
                  <table class="table align-items-center justify-content-center mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{ url('pengaduan/terima/'.$row->id) }}" type="button" class="btn btn-sm btn-primary">Setujui</a>

                            <a href="{{ url('pengaduan/tolak/'.$row->id) }}" type="button" class="btn btn-sm btn-danger">Tolak</a>
                        </td>
